...
*   [Poetry](https://python-poetry.org/docs/#installation) (для зависимостей и тестов в этом репозитории)
...
2.  **Скрипт интерфейса:** скопируйте `HTTPInterface.py` в каталог интерфейсов Reticulum, например `~/.reticulum/interfaces/`.
